...
description: "NixOS networking and security expertise: firewall configuration, SSH hardening, VPN setup (WireGuard/Headscale), TLS/ACME certificates, DNS, and system security hardening. Use when configuring firewall rules, SSH, VPN, TLS certificates, DNS, or security hardening."
---
