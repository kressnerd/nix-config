---
name: nixos-server
description: "NixOS system-level configuration expertise: services, systemd hardening, disk management with disko, impermanence patterns, and boot configuration. Use when configuring system services, systemd units, disk management, boot, or impermanence."
---
