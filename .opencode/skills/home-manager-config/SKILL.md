...
description: "Home Manager user-level configuration expertise: program modules, shell setup, editor configuration, XDG management, and cross-platform Linux/macOS patterns. Use when configuring user programs, shells, editors, browsers, desktop environments, or cross-platform features."
---
