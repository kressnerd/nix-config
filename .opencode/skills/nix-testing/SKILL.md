---
name: nix-testing
description: "All test types in the nix-config repository: pure Nix unit tests (lib.debug.runTests), NixOS module assertions, QEMU-based integration tests (pkgs.testers.runNixOSTest), and post-deployment validation (pytest-testinfra). Use when writing tests, test infrastructure, nixosTest, assertions, or following the Red-Green-Refactor test-first workflow."
---
