...
description: "Step-by-step procedure for creating a new Python CLI tool in scripts/, following TDD (Red-Green-Refactor), type hints, ruff/mypy quality gates, and argparse CLI conventions (PY-TDD-001, PY-QUAL-001, PY-NIX-001, PY-CLI-001). Use when creating a new Python CLI tool."
---
