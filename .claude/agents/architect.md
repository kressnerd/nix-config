---
name: architect
description: "Plans and designs implementations for this nix-config repo. Produces plans with Phase 0 validation strategy. Never writes implementation code. Use before coder for non-trivial changes."
...
## Current Status
Real-time progress tracking (updated by coder during execution).
```
