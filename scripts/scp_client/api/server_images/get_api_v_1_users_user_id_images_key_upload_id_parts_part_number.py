...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/users/{user_id}/images/{key}/{upload_id}/parts/{part_number}".format(
            user_id=user_id,
            key=key,
            upload_id=upload_id,
...
def sync_detailed(
    ...
    *,
    ...
    Once all parts are uploaded, call \"PUT /api/v1/users/{userId}/images/{key}/{uploadId}\" with the
    list of all uploaded parts,
