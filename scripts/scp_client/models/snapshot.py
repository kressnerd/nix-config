...
class Snapshot:
    ...
    download_infos: S3DownloadInfos | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        download_infos: dict[str, Any] | Unset = UNSET
        if not isinstance(self.download_infos, Unset):
            download_infos = self.download_infos.to_dict()
        ...
        if download_infos is not UNSET:
            field_dict["downloadInfos"] = download_infos
