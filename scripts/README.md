...
```
Creates a policy with explicit DROP rules for all protocols (TCP, UDP, ICMP, ICMPv6) in both INGRESS and EGRESS directions, blocking all inbound and outbound traffic. Assigns it to all interfaces. Auto-backup is created first.
