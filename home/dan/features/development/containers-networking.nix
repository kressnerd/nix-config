...
}:
{
  ...
  home = {
    ...
    file = {
      ".config/containers/networks/development.json".text = builtins.toJSON {
        name = "development";
        id = "dev-network-001";
        driver = "bridge";
      ...
      ".config/containers/networks/isolated.json".text = builtins.toJSON {
        name = "isolated";
      ...
      ".config/containers/volumes/development-mounts.yaml".text = ''
      ...
      ".config/containers/examples/networking-compose.yaml".text = ''
        version: '3.8'
      ...
      ".config/containers/examples/k8s-networking.yaml".text = ''
